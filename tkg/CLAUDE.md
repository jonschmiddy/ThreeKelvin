...
| **Discard verbs never ask the player to choose** | `purge` takes UNPLAYABLE cards out of hand and `dump_hand` throws the whole hand away; neither offers a selection. "Discard N of your choice" wants the hand to become a selectable mode, which is a UI this game does not have and a much bigger thing than a card field. These two cover the case malfunctions create, and the choosing version can come later without changing either |
