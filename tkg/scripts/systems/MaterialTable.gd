...
static func all() -> Array[Dictionary]:
	...
	_all = [
		...
		{id = &"bearing_race", name = "BEARING RACES", tier = &"common", cells = "1x1",
			...
			text = "A crate of circles. Most of what turns on a ship turns on one of these."},
		...
		{id = &"dock_lamp", name = "DOCK LAMPS", tier = &"rare", cells = "2x1",
			...
			text = "Approach lighting, the exact green of arriving somewhere. Crews on long runs hang one in the cabin."},
		...
		{id = &"one_true_metre", name = "THE ONE TRUE METRE", tier = &"legendary", cells = "1x1",
			...
			text = "A calibration bar every scale in three shells defers to. Whoever holds it is right about weight until somebody takes it off them."},
		...
		{id = &"flank_ivory", name = "FLANK IVORY", tier = &"exotic", cells = "2x1",
			...
			text = "Grows along a megafauna's leading edge, where space itself wears things smooth. Carves like old bone."},
		{id = &"heart_brine", name = "HEART BRINE", tier = &"exotic", cells = "1x1",
			value = 62, drops = &"fauna",
			text = "The fluid a four-chambered heart the size of a shuttle moves. Keeps its warmth for months, and warmth is what the manufacturers buy."},
		...
		{id = &"wrong_mass", name = "WRONG MASS", tier = &"artifact", cells = "1x1",
			...
			text = "Fist-sized, weighs like a hull section, and the weight moves a half-second after you do. The deep wrecks it comes off are balanced the same way."},
		{id = &"last_broadcast", name = "LAST BROADCAST", tier = &"artifact", cells = "1x1",
		...
		{id = &"singing_tine", name = "SINGING TINE", tier = &"artifact", cells = "2x2",
			...
			text = "One tine in a cradle, and it was already ringing when it was found. Set it on the deck and the plates take it up. Nobody has heard it stop."},
