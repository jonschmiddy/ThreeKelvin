...
## The mark colour: emblem, accents, anything this manufacturer draws ON its ground.
## What manufacturer_colour() returns, because it is the half that reads on a
## dark UI.
@export var colour: Color = Color.WHITE
## The banner ground. Two colours per manufacturer rather than one, because a banner is
...
## luxury and clinical look like themselves next to five dark manufacturers.
@export var field: Color = Color("#16202e")
## Who they are. Two or three sentences of company, not of mechanics —
## `identity` already says what flying them DOES, and a player choosing a manufacturer
